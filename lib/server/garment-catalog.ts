...
const garmentProviderConfiguration: Record<string, GarmentProviderConfiguration> = {
  ...
  "g-002": {
    imageLocation: {
      type: "local",
      path: "garments/g-002 Cargo Trousers.png",
    },
  ...
  "g-003": {
    imageLocation: {
      type: "local",
      path: "garments/g-003 Slip Dress.png",
    },
  ...
  "g-004": {
    imageLocation: {
      type: "local",
      path: "garments/g-004 Leather Jacket.png",
    },
    youCamCategory: "upper_body",
  },
  "g-005": {
    imageLocation: {
      type: "local",
      path: "garments/g-005 Festival Set.png",
    },
    youCamCategory: "full_body",
  },
  "g-006": {
    imageLocation: {
      type: "local",
      path: "garments/g-006 Midi Skirt.png",
    },
    youCamCategory: "lower_body",
  },
}
